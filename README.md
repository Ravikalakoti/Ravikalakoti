...
- [VDGPasskit]  
  - Developed a pass management system for generating Apple Wallet and Google Wallet passes.  
  - Implemented templates and landing pages for organizations to create and distribute digital passes.  
  - Integrated secure authentication and API-based pass generation.  
  - Worked on optimizing the backend performance and database queries.
<br>
